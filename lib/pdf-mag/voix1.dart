...
class Voix1 extends StatefulWidget {
  @override
  _Voix1State createState() => _Voix1State();
}

class _Voix1State extends State<Voix1> {
  ...
  void initState() {
    _pdfController = PdfController(
      document: PdfDocument.openAsset('docMag/lavoix-septembre.pdf'),
